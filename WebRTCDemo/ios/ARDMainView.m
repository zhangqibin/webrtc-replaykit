...
@implementation ARDMainView {
  ...
  UIButton *_screenRecordingButton;
}
...
- (void)layoutSubviews {
  ...
  CGFloat buttonHeight =
      (CGRectGetMaxY(self.bounds) - CGRectGetMaxY(_roomText.frame) - kCallControlMargin * 4) / 4;
  ...
  CGRect audioLoopFrame = CGRectMake(kCallControlMargin,
                                     ...
                                     bounds.size.width - 2*kCallControlMargin,
                                     buttonHeight);
  CGFloat screenRecordingTop = CGRectGetMaxY(audioLoopFrame) + kCallControlMargin;
  CGRect screenRecordingFrame = CGRectMake(kCallControlMargin,
                                       screenRecordingTop,
                                       bounds.size.width - 2*kCallControlMargin,
                                       buttonHeight);
  ...
  _screenRecordingButton.frame = screenRecordingFrame;
}
